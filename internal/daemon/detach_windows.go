...
// ShouldDetach is true: console returns immediately, supervisor runs in a detached process group.
func ShouldDetach() bool { return true }

// LaunchDetached starts a background child (no console) and exits this process with code 0.
